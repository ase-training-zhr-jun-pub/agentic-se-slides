...
<div class="space-y-6 text-xl leading-relaxed">
  ...
  <p><span class="font-bold">Purpose:</span> Creates hypothetical user profiles based on assumptions and existing data. Faster than complete personas, but still helpful for product decisions.</p>
